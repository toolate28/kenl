...
KENL1 serves as the **foundation layer** for all other KENL modules:

```mermaid
graph TD
    KENL1[KENL1: Framework Core] --> KENL2[KENL2: Gaming]
    KENL1 --> KENL3[KENL3: Development]
    KENL1 --> KENL4[KENL4: Monitoring]

    KENL2 --> GWI[Gaming-With-Intent]
    KENL3 --> CWI[Configuring-With-Intent]
    KENL4 --> MWI[Monitoring-With-Intent]
```
...
- **[mcp-governance/](./mcp-governance/)** - ARCREF templates for infrastructure decisions
- **[02-Decisions/](./02-Decisions/)** - ADR templates for architectural decisions
...
## Using KENL1 as Foundation

### For Gaming (KENL2)

```bash
# Install KENL1 framework first
...
claude: "Activate KENL2 gaming module"
# → Automatically installs KENL1, then KENL2

claude: "Setup development environment with KENL3"
# → Installs KENL1, configures KENL3 with distrobox

claude: "Enable monitoring with KENL4"
# → Installs KENL1, deploys KENL4 observability stack
```

**How it works**:
- KENL1 provides base ATOM/SAGE/OWI framework
- Other KENLs are lightweight modules
