...
[Service]
Type=simple
ExecStart=/usr/bin/distrobox enter kenl-monitoring -- prometheus --config.file=\$HOME/kenl/modules/KENL4-monitoring/prometheus/prometheus.yml --storage.tsdb.path=\$HOME/.prometheus
Restart=on-failure
