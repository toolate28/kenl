...
echo -e "   ${KENL_CYAN}context-sync --version${KENL_RESET}   # Check that context-sync is installed"
echo -e "   ${KENL_YELLOW}(Automated test script coming in Phase 2: ./test-installation.sh)${KENL_RESET}"
echo ""
