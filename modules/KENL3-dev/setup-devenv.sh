...
if [ -d "$HOME/kenl/modules/KENL1-framework/atom-sage-framework" ]; then
    cd "$HOME/kenl/modules/KENL1-framework/atom-sage-framework"
    ./install.sh
    echo "✅ KENL1 framework installed"
else
    echo "⚠️  KENL1 framework not found at ~/kenl/modules/KENL1-framework"
