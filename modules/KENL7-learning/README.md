# modules/KENL7: Learning - Tutorials & Walkthroughs
...
```bash
kenl-switch 0
emergency-rollback  # modules/KENL0 function: rollback + reboot automatically
```
...
```bash
kenl-switch 0
qa-ujust  # modules/KENL0 wrapper: ujust with ATOM trail logging
```
...
```bash
kenl-switch 8
encrypt-file secret.txt  # modules/KENL8 wrapper, creates secret.txt.gpg
...
**What gets restored:**
- All modules/KENL configurations
