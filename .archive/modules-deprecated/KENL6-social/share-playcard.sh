...
PLAYCARD_DIR="$HOME/kenl/modules/KENL2-gaming/play-cards"
KENL8_GPG="$HOME/kenl/modules/KENL8-security/gpg-keyring"
...
share_link() {
    ...
    local link=$("$HOME/kenl/modules/KENL10-backup/cloud-backends/upload.sh" "$encrypted")
