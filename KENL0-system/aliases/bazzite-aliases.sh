...
# Chained operations
alias qa-update='~/kenl/KENL0-system/quick-actions/update-verify.sh'
alias qa-rebase='~/kenl/KENL0-system/quick-actions/rebase-clean.sh'
alias qa-ujust='~/kenl/KENL0-system/ujust-integration/ujust-atom.sh'
...
# KENL modules
alias kenl1='cd ~/kenl/KENL1-framework'
alias kenl2='cd ~/kenl/KENL2-gaming'
alias kenl3='cd ~/kenl/KENL3-dev'
alias kenl4='cd ~/kenl/KENL4-monitoring'
alias kenl5='cd ~/kenl/KENL5-facades'
alias kenl0='cd ~/kenl/KENL0-system'
