# KENL9: Library - Multi-OS Game Library Management
...
- 🔐 **Cloud save backup** (encrypted via KENL8)
...
sequenceDiagram
    ...
    KENL9->>KENL9: Add to library tracking
    KENL9-->>User: ✅ Library ready
...
**Why:** Steam manages game installs, updates, and verification. KENL9 tracks which library games belong to.
...
**Result:**
| Metric | Without KENL9 | With KENL9 |
|--------|---------------|------------|
...
```bash
# KENL2 Play Cards work across OSes
kenl-switch 2
...
```bash
# KENL9 tracks Windows-only games
...
**Why:** SSDs dramatically improve load times. KENL9 automatically moves frequently-played games to fastest storage.
